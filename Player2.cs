...
public class Player2 : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        gunID = PlayerPrefs.GetInt("player2Gun");
        switch (gunID)
        {
            case 1:
    ...
    private void Update()
    {
        ...
        PlayerPrefs.SetInt("Player2Health", health);
        PlayerPrefs.SetInt("Player2MagazineCapacity", magazineCapacity);
        PlayerPrefs.SetInt("Player2Bullets", bulletsTotal);
        PlayerPrefs.SetInt("Player2BulletsInMagazine", bulletsInMagazine);
    ...
    private IEnumerator CheckForDeath()
    {
        ...
        {
            var score = PlayerPrefs.GetInt("Player2Score");
            score++;
